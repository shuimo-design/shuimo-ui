...
import { PaginationProps } from '../../../lib/template/pagination';
import { Pager, usePagination } from '../../../lib/template/pagination/usePagination';
import { MRefValue } from '../../../composition/common/MRef';
...
describe('pagination hook', function () {
  ...
  const getPagination = (props: PaginationProps, value?: { currentValue?: MRefValue<number> }) => {
    return usePagination({ ...baseProps, ...props }, { currentValue, ...value });
  };
        ...
        describe('when maxPageBtn is not null', () => {
          ...
          describe('need fold', function () {
            ...
            describe('not show edge', () => {
              const getHide = (props: PaginationProps, value?: { currentValue?: MRefValue<number> }) => getPagination({
                ...props,
