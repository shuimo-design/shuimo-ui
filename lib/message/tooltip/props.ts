...
import { WTooltipProps } from './type';

export default {
  placement: {
    type: String as PropType<WTooltipProps['placement']>,
    default: 'bottom',
   ...
   */
  openDelay: {
    type: [Number] as PropType<WTooltipProps['openDelay']>,
    default: 0,
  },
  /**
   ...
   */
  closeDelay: {
    type: [Number] as PropType<WTooltipProps['closeDelay']>,
    default: 0,
  },
  /**
